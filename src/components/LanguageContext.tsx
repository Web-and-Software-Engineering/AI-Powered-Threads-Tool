...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "gen.reference.placeholder": "Paste the text of posts you want to use as style references (one per line). Links aren't fetched — paste the post's text directly.",
  ...
  jp: {
    ...
    "gen.reference.placeholder": "スタイルの参考にしたい投稿の文章を貼り付けてください (1行に1件)。リンクは取得されないため、投稿の文章を直接貼り付けてください。",
