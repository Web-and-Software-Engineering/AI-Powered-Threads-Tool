...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "profile.bio.placeholder": "Toss in any casual details about you (e.g., background, personality, values, likes/dislikes, dreams, lifestyle, life views, or random thoughts) so the AI can capture your authentic voice.",
  ...
  jp: {
    ...
    "profile.bio.placeholder": "自己紹介、性格の特徴、好きなこと・嫌いなこと、将来の夢、価値観、ライフスタイルなど、あなたのペルソナに関するメモを自由に入力してください。AIがあなたの個性を反映した自然な投稿を作成します。",
